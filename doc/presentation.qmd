...
![Figure 1: Bar plot with the distribution of patients who experienced radiation-induced Hemorrhagic Cystitis (HC) based on the type of treatment received.](images/key_plot_1.1-01.png)
:::

::: {.column .img-bg width="50%"}
#### dat_aug1: 80 observations and 26 variables

![Figure 2: Boxplot Analysis of numeric variables from patients that developed HC. Multifaceted Data Distributions Across numeric variables and outliers are visualized.](images/key_plot_1.8-02.png)
:::
:::
...
-   Libraries: `ggplot`, `base`

## Key findings 1

::: columns
::: {.column .img-bg width="50%"}
![Figure 3: Analysis of Radiation Dose Percentages in correlation to the different radiation types. According to literature, a standardized threshold has been added distinguishing Low, Medium, and High Levels across various radiation types.](images/key_plot_1.3-01.png)
:::

::: {.column .img-bg width="50%"}
![Figure 4: Bar plot displaying the average time passed since the completion of radiation treatment and the first incidence of HC. Each bar corresponds to a radiation treatment category.](images/key_plot_1.4-02.png)
:::
:::
...
::: columns
::: {.column .img-bg width="50%"}
![Figure 5: Prevalence of comorbidities in HC patients: A Count of Recurrent Conditions. The data is limited to patients with more than one comorbidity.](images/key_plot_1.10.png)
:::

::: {.column .img-bg width="50%"}
![Figure 6: Incidence of multiple Hospital Complications among HC patients. A count of hospitalin complications. The Data is limited to patients with more than one complication.](images/key_plot_1.11.png)
:::
:::
...
::: columns
::: {.column .img-bg width="50%"}
![Figure 7: Dimensionality Reduction and Pattern Detection. It enables to discern whether patients with cancer in specific organs exhibit consistent patterns across quantitative variables such as the Grading system, Radiation dosage, Duration of radiation, and the Number of comorbidities.](images/key_plot_2.1.png){width="80%"}
:::

::: {.column .img-bg width="50%"}
![Figure 8: Scatterplot Analysis with Regression Line. It elucidates the correlation between patient age at the time of radiation and their number of comorbidities, as related to their hospital stay duration.](images/key_plot_2.4.png)
:::
:::
...
-   The study unveils potential underreporting in HC cases, despite advancements in radiation therapy.
-   HL has the highest prevalence among the comorbidities, while UTIs and AKI are the most common hospital complications.
-   The use of EBRT and brachytherapy was linked to a quicker development of HC, while mixed neutron-photon IMRT therapy was linked to HC development at 75 months or late.
-   15% of patients underwent EBRT medium dose therapy, while 10% received IMRT medium dose therapy, making them the two most prevalent radiation treatments.

## Analysis 2

-   The PCA biplot's lack of distinct variable clustering suggests no clear separation between bladder and prostate cancer characteristics within our limited dataset.
The scarcity of bladder cancer data points highlights the need for a more extensive and balanced dataset to accurately differentiate between these two cancer types.

-   The scatterplot with the linear regression line reveals a subtle trend indicating longer hospital stays associated with older patients and those with a higher number of comorbidities.
This observation suggests that age and comorbidities might be predictive factors in determining the duration of hospitalization in this patient cohort.
