...
::: {.column .img-bg width="50%"}
![Figure 7: Scatterplot Analysis with Regression Line. It elucidates the correlation between patient age at the time of radiation and their number of comorbidities, as related to their hospital stay duration.](images/key_plot_2.4.png)
:::
:::
