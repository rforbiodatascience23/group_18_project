...
write.csv(hc_patient_data, 
          file = "~/group_18_project/data/clean_hc_patient_data.csv", row.names = FALSE)
    

# Save data in hc_patient_data
write.table(hc_patient_data, 
...
# Save clean datasets in tsv files

```{r}

# Save data in combined_patient_info
write_tsv(
  x= combined_patient_info, 
