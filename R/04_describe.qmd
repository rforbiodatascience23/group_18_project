...
-   **`num_days_admited`** indicates the number of days a patient was admitted to the hospital.
    Tracking hospital admission days provides insights into the impact of radiation therapy on patients' well-being, including potential complications and recovery periods.
...
Shortly describe what the plot shows
