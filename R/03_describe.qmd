...
The dataset `dat_clean1` shows the information on 80 patients who underwent radiation therapy for prostate cancer between January 2000 and September 2015 in two Detroit Medical Center hospitals. The primary focus of the analysis is to assess the frequency and severity of radiation-induced hemorrhagic cystitis (HC) in these patients. Standard information of each patient is given such as: `date_of_birth`, `age_at_radiation`, `height` and `weight`, but the following variables were important to look at:
