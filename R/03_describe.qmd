...
The dataset `dat_clean1` shows the information on 80 patients who underwent radiation therapy for prostate cancer between January 2000 and September 2015 in two Detroit Medical Center hospitals. The primary focus of the analysis is to assess the frequency and severity of radiation-induced hemorrhagic cystitis (HC) in these patients. Standard information of each patient is given such as: `date_of_birth`, `ethnicity`, `age_at_radiation`, `height` and `weight`, but the following variables were important to look at:
...
-   **`hematuria_grade`** indicating the severity or grade of hematuria experienced by patients. Hematuria grade is a qualitative assessment of the severity of blood in the urine. It ranges from mild to severe, reflecting the amount and
    visibility of blood. Understanding hematuria grade provides insights into the severity of complications, especially those induced by radiation therapy.
...
The table shows the key statistics of the different variables. The dataset includes patients with a mean age at radiation of 68.7 years, a median age of 68.5 years, which ranges from 48 to 89 years. The ethnicity information is available for 90% of patients, with the majority being African American (92.5%) while Caucasians make up 7.5% of the dataset. The most common type of radiation is EBRT at 55% and different combinations of radiation types are also present, with varying frequencies. Missing data is observed for 7.5% of the cases.
