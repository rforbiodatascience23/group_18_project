...
Description: This boxplot shows the Analysis of Patient Dose Percentages. A standardized threshold has been added distinguishing Low, Medium, and High Levels across various radiation types. Analysing this plot could give insights into the distribution of radiation dosage.
...
result_3 <- 
  ...
  summarise(Percentage = n()/nrow(analysis_1.1)) |> 
  filter(!is.na(dose_category) & !is.na(radiation_type) & !is.na(Percentage)) |>  
  ungroup()

# Create a grouped bar plot with viridis color scheme
plot3 <- result_3 |> 
  ...
  labs(title = "Radiation Dosage Category" ,
       ...
       #x = "Type of Radiation",
       y = "Percentage of radiation dose",
...
please describe the plot herePlot 5
...
plot7 <- ggplot(data = analysis_1.1, 
