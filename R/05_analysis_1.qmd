...
plot7 <- plot(km_fit, main = "Kaplan-Meier Curve of HC-Free Survival P. vs Time",
              ...
              col = "blue", lwd = 2, conf.int = FALSE, ylim = c(0, 1))
...
```{r}
# Boxplot
plot8 <- ggplot(analysis_1, aes(x = radiation_type, y = radiation_duration, fill = radiation_type)) +
  geom_boxplot() +
...
# Save the plot to folder results
ggsave(filename = "key_plot_8.png", 
      plot = plot8, 
      path = "~/group_18_project/results",
      width = 8, 
      height = 5, 
